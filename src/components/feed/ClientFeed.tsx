...
import { Industry, Experience } from "@/src/lib/enums";
import api from "@/src/lib/axios";
import { Freelancer } from "@/src/types/freelancer";
...
export default function ClientFeed() {
    ...
    if (searchTerm) {
      ...
      result = result.filter(
        (freelancer) =>
          ...
          freelancer.skills.some((skill: any) =>
  ...
  const experienceLevels = [
    ...
    { value: Experience.BEGINNER, label: "Beginner" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
            {filteredFreelancers.map((freelancer) => (
              <FreelancerCard
                ...
                experience={freelancer.experience as Experience}
