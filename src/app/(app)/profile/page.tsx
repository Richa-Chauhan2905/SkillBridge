...
import FreelancerProfile from '@/src/components/profile/FreelancerProfile';
import ClientProfile from '@/src/components/profile/ClientProfile'; // adjust name if needed
